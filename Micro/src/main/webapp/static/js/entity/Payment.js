...
entityModule.factory('EntityService', ['$http', '$q', function($http, $q){
    ...
    var entityRec = {
        name   :'Payment',
        record :{id:{patientId:'', treatmentId:'', paymentNo:''},paymentDate:null, paymentType:'',paymentMethod:'',amount:'',chequeNo:'',chequeExpDate:'',chequeBank:'',objid:null, selected:false},
        emptyRecord :emptyRecord,
        tmpRecord :emptyRecord,
        recordSearch :{id:{patientId:'', treatmentId:'', paymentNo:''},paymentDate:null, paymentType:'',paymentMethod:'',amount:'',chequeNo:'',chequeExpDate:'',chequeBank:'',objid:null},
    ...
    function emptyRecord() {
        return {id:{patientId:'', treatmentId:'', paymentNo:''},paymentDate:null, paymentType:'',paymentMethod:'',amount:'', chequeNo:'',chequeExpDate:'',chequeBank:'',objid:null, selected:false};
    }	
}]);/**
 * 
 */