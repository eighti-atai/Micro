...
<html>
	...
	<body ng-app="generalModule" class="ng-cloak" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-12" data-genuitec-path="/Micro/src/main/webapp/WEB-INF/views/TmpAppointments.jsp">
		<div id="con1" class="generic-container" data-ng-controller="RecordController as ctrl" ng-init="ctrl.init()" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-12" data-genuitec-path="/Micro/src/main/webapp/WEB-INF/views/TmpAppointments.jsp">  
