...
<body ng-app="generalModule" class="ng-cloak" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/Micro/src/main/webapp/WEB-INF/views/AppointmentsDates.jsp">
	<div id="con2" class="generic-container" data-ng-controller="RecordController as ctrl" ng-init="ctrl.init();ctrl.setPanelHeader('Appointments')" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/Micro/src/main/webapp/WEB-INF/views/AppointmentsDates.jsp">
