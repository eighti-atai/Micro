...
<!--<body ng-app="generalModule" class="ng-cloak">
  ...
  <body ng-app="generalModule" class="ng-cloak" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/Micro/src/main/webapp/WEB-INF/views/SubTreatmentTypes.jsp">
	<div id="con" class="generic-container" data-ng-controller="RecordController as ctrl" ng-init="ctrl.MasterInit();" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/Micro/src/main/webapp/WEB-INF/views/SubTreatmentTypes.jsp">   
