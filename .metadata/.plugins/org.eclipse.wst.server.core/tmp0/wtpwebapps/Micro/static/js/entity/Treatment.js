...
entityModule.factory('EntityService', ['$http', '$q', function($http, $q){
    ...
    function emptyRecord() {
        return {id:{treatmentId:'',patientId:''} ,patient:{patientId:'',patientName:''}, mttId:'', sttId:'',treatmentDesc:'', treatmentStat:'', treatmentPaidStat:'', treatmentDate:'',treatmentAmount:'',treatmentDiscount:'',treatmentTotal:'',treatmentPaid:'',treatmentImage:null,objid:null};
    }	
}]);
