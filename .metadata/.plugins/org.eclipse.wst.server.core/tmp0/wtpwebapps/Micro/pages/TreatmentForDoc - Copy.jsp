...
<body onresize="resizeIframe()" onload="resizeIframe()" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-25" data-genuitec-path="/Micro/src/main/webapp/pages/TreatmentForDoc - Copy.jsp">
...
<iframe  id="f1" onload="iframeLoaded('f1')" scrolling="no"  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-25" data-genuitec-path="/Micro/src/main/webapp/pages/TreatmentForDoc - Copy.jsp">
</iframe>
<!--  </div> -->
 <div>
 </div>
